...
function styledFn(Dynamic, configOrCva = {}, options = {}) {
  ...
  const CpComponent = /* @__PURE__ */ forwardRef(function CpComponent(props, ref) {
  ...
  CpComponent.displayName = `cp.${name}`
  CpComponent.__cva__ = cvaFn
  CpComponent.__base__ = Dynamic
  CpComponent.__shouldForwardProps__ = shouldForwardProp
...
export const cp = /* @__PURE__ */ createJsxFactory()
